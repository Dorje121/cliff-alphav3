...
import SpecialLens from '@/components/pagecontents/speciallense';

export default function SpecialLensePage() {
  return (
      ...
      <section className="relative h-screen flex flex-col justify-between items-center py-8 md:pb-16 overflow-hidden">
        ...
        <div className="relative z-[2] flex flex-col items-center justify-center h-full">
          ...
          <p className="text-xl mt-4 text-center max-w-2xl px-4">
            Advanced lens solutions for every visual need and lifestyle
          </p>
        </div>
          ...
          {[
            {
              ...
              title: "Tint Options",
              desc: "Multiple colors to suit your style",
            },
            {
              icon: "/svgs/photochromatic.svg",
              title: "Adaptive Lenses",
              desc: "Auto-adjusting to light conditions",
            },
            {
