...
const CliffTintedLenses = () => {
  ...
  return (
    <>
      {/* Hero Section */}
     <section className="relative w-full min-h-[40vh] bg-black text-white overflow-hidden">
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent z-0"></div>

            {/* Content */}
            <div className="w-full px-6 lg:px-12 relative z-10">
                <div className="max-w-[94rem] mx-auto flex items-center pt-24 pb-20">
                <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-10">
                    {/* Left Content */}
                    <div className="lg:w-1/2 lg:pr-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl montserrat text-yellow-400 mb-6">
                        Cliff Tinted <span className="text-white">Lenses</span>
                    </h1>
                    <p className="text-xl text-amber-100 mb-8 max-w-2xl leading-relaxed">
                        Fashionable tinted lenses with a perfect balance of protection, performance, and style.
                        Designed to reduce glare, enhance contrast, and provide full UV protection — keeping your
                        eyes comfortable and stylish in any light.
                    </p>
                    </div>

                    {/* Lens Image - Right Side */}
                    <div className="lg:w-1/2">
                    <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden border border-gray-700 shadow-lg">
                        <Image
