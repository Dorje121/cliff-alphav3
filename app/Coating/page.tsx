        ...
        <div className="mb-8 md:mb-16">
          <div className="flex flex-col mt-8 lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-8">
            ...
            <div className="flex-1">
              ...
              <p className="text-base sm:text-lg md:text-xl  max-w-4xl">
                Explore our advanced lens coating technologies, offering
                superior protection, enhanced clarity, and lasting comfort —
                engineered to reduce glare, resist scratches, and keep your
                vision crystal clear in every environment.
              </p>
            </div>
          </div>
        </div>
