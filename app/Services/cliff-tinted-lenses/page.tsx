...
const CliffTintedLenses = () => {
  ...
  // Individual state for each category section
  const [selectedTints, setSelectedTints] = useState<Record<string, {
    color: string;
    name: string;
    category: string;
    hex: string;
  }>>({
    "Grey": { color: "bg-gray-300", name: "Grey 25%", category: "Grey", hex: "#D1D5DB" },
    "Black": { color: "bg-gray-900", name: "Black 25%", category: "Black", hex: "#111827" },
    "Brown": { color: "bg-amber-300", name: "Brown 25%", category: "Brown", hex: "#FBBF24" },
    "Green": { color: "bg-green-300", name: "Green 25%", category: "Green", hex: "#86EFAC" },
    "Pink": { color: "bg-pink-300", name: "Pink 25%", category: "Pink", hex: "#F9A8D4" }
  });
