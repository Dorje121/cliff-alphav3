  ...
  return (
    <>
      <HeroSection
        ...
        backgroundImage="/cliffcoating/changable.gif"
        rightImage="/cliffcoating/changable.gif"
        serviceNumber="08"
        badgeTitle="Style"
            ...
            {tintCategories.map((category, categoryIndex) => (
              ...
              >
                <div className="h-[100dvh] w-full z-[99] relative">
                  ...
                  <div className="absolute flex justify-end gap-16 items-center flex-col z-40 inset-0 p-4 lg:p-6">
                    <div className=" relative">
                      <svg
                        className="w-[90%] md:w-80 lg:w-96 "
                        viewBox="0 0 805 602"
                        fill="none"
                      ...
                      {category.tints.map((tint, tintIndex) => (
                        <div key={tintIndex} className="group">
                          <div className=" ">
                            {/* Tint Circle */}
                            <div
                              className={`relative mx-auto mb-3 size-10 rounded-full border-2 cursor-pointer overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-lg ${
                                selectedTint.name === tint.name &&
                                selectedTint.category === category.name
