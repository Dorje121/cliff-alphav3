      ...
      <div className="overflow-x-auto rounded-2xl border border-gray-800 mb-8">
        <table className="w-full text-left text-sm sm:text-base">
          <thead className="bg-gray-800/50">
            <tr>
              <th className="py-3 px-4 font-semibold text-gray-300">INDEX</th>
              <th className="py-3 px-4 font-semibold text-gray-300 text-center">BLUE SAFE</th>
              <th className="py-3 px-4 font-semibold text-gray-300 text-center">PHOTO Z</th>
            </tr>
          </thead>
          <tbody>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-gray-800/30 rounded-xl p-3 sm:p-4 text-center border border-gray-700/50">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Range</p>
                <p className="font-semibold">{item.range}</p>
              </div>
              <div className="bg-gray-800/30 rounded-xl p-3 sm:p-4 text-center border border-gray-700/50">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Add</p>
                <p className="font-semibold text-yellow-400">{item.add}</p>
              </div>
            </div>
            
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-800">
              <h5 className="font-semibold text-gray-300 mb-2 sm:mb-3">Key Benefits:</h5>
