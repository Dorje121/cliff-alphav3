  ...
  return (
    ...
    <section className="bg-black">
      <div className="grid grid-cols-1 md:grid-cols-3">
        {/* Card 1 */}
        <Link href="/photochromaticplus" className="block h-[40vh] w-full">
        ...
        {/* Card 2 */}
        <Link href="/tinted-lenses" className="block h-[40vh] w-full">
          <div className="relative h-full w-full">
            <Image
              src="/product/6.jpg"
              alt="UV Protection"
        ...
        {/* Card 3 */}
        <Link href="/polarized" className="block h-[40vh] w-full">
          <div className="relative h-full w-full">
            <Image
              src="/product/7.jpg"
              alt="All-Day Comfort"
