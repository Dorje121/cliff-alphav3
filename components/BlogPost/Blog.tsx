    ...
    <div className="min-h-screen bg-transparent text-white">
      ...
      <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto text-left">
          <h1 className="text-5xl italic md:text-9xl font-bold font-family-playfair mb-6 py-6 bg-gradient-to-r from-white via-yellow-100 to-yellow-200 bg-clip-text text-transparent">
            Cliff Insights & Updates
          </h1>
