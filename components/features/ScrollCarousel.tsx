      ...
      <section ref={containerRef} className="relative overflow-hidden">
        ...
        >
          {cardData.map((card, index) => (
            <>
              <div
                className="bg-gradient-to-b from-zinc-700 via-transparent to-zinc-500 
 p-0.5 rounded-3xl "
              >
                <Card
                  key={index}
                  ...
                  } md:w-[30vw] w-full flex-shrink-0  hover:shadow-2xl transition-all duration-500  overflow-hidden relative rounded-3xl`}
                >
                  {/* Background Image */}
                  <div
