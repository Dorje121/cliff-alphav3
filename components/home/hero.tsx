      ...
      <div className="relative z-10 text-center text-white px-4 md:px-8 mx-auto">
        <div className="flex flex-col w-full h-full mb-12">
          ...
          <TextWithTexture
            ...
            className="text-4xl sm:text-6xl lg:text-9xl poppins font-bold leading-tight"
          />

          <div className="flex flex-col lg:flex-row">
            <TextWithTexture
              text="Just for you"
              className="text-4xl md:text-6xl lg:text-9xl poppins font-bold mb-6 leading-tight"
            />
