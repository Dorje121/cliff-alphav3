...
const HomeTechnology = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      image: "/product/5.jpg",
      buttonText: "Learn about DRIVE CLEAR",
    },
    {
      id: "04",
      title: "PHOTO Z",
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.utils.toArray(".category-section").forEach((section: any, index) => {
        ...
        // Enhanced image animation with alternating directions based on index
        const isEven = index % 2 === 0;
        const initialRotation = isEven ? 25 : -25;
        const initialX = isEven ? 300 : -300;
