...
const CliffCoatings = () => {
  ...
  <div className="max-w-[1500px] mx-auto p-4">
    <h2 className="text-3xl font-bold text-center mb-12 text-white">Lens Coating Options</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      
      {/* Blue Safe */}
      <div className="p-6 border border-gray-700 rounded-xl shadow-sm hover:shadow-md transition bg-gray-900">
        <h3 className="text-xl font-semibold mb-4 text-blue-400">Blue Safe</h3>
      ...
      {/* Drive Clear */}
      <div className="p-6 border border-gray-700 rounded-xl shadow-sm hover:shadow-md transition bg-gray-900">
        <h3 className="text-xl font-semibold mb-4 text-green-400">Drive Clear</h3>
        <ul className="space-y-2 text-gray-300">
          <li>✅ UV Protection</li>
          <li>✅ Scratch Resistance</li>
          <li>✅ Anti-Reflective Coating</li>
          <li>✅ Easy to Clean</li>
          <li>➖ Partially Filters Blue Rays</li>
      ...
      {/* Photo-Z */}
      <div className="p-6 border border-gray-700 rounded-xl shadow-sm hover:shadow-md transition bg-gray-900">
        <h3 className="text-xl font-semibold mb-4 text-purple-400">Photo-Z</h3>
        <ul className="space-y-2 text-gray-300">
          <li>✅ UV Protection</li>
          <li>✅ Scratch Resistance</li>
          <li>✅ Anti-Reflective Coating</li>
