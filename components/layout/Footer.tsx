...
const Footer = () => {
  return (
    <footer
      className="relative md:h-[100vh] backdrop-blur-sm flex items-center justify-center text-white bg-cover bg-center bg-no-repeat"
