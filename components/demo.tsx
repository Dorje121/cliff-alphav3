...
import Floating, {
  FloatingElement,
} from "@/components/ui/paralaxfloating"

const exampleImages = [
  {
    url: "/bluesafe/blue.png",
    title: "Blue Light Protection Lens",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/drive.png",
    title: "Drive Safe Lenses",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/clear.png",
    title: "Clear Vision Lenses",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/stock-Cliff.jpg",
    title: "Premium Lenses",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/lense.jpg",
    title: "Lens Technology",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/photoz.jpg",
    title: "PhotoZ Technology",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/ctalist.jpg",
    title: "Call to Action",
    author: "Cliff Lenses"
  },
  {
    url: "/bluesafe/driveclear.png",
    title: "Drive Clear Lenses",
    author: "Cliff Lenses"
  }
]
...
const Preview = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-5xl md:text-7xl montserrat text-[#FFD700] z-50 font-calendas italic">
